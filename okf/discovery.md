...
description: How fokf finds OKF bundles across projects, and the placement model it assumes.
...
within a larger repository" (§3). So fokf chooses a convention the spec permits:
...
- **Browsing is centralized** — fokf discovers many bundles under configured *search
...
`fokf <bundle-dir>` skips the picker and opens that bundle directly.
